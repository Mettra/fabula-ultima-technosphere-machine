 ...
 */
export async function runVisualParticleTest(duration: number = 3000): Promise<void> {
    ...
    testContainer.innerHTML = '<div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 24px; text-align: center;">Testing Particles<br><small>Click anywhere to close</small></div>';
