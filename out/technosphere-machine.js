import { getCharacter, getFlag, Log, MEMNOSPHERE_ROLL_COST, ModuleName, SetFlagWithoutRender } from "./core-config.js";
...
Hooks.on(`renderFUPartySheet`, async (sheet, html) => {
    ...
    html.find(".sheet-tabs").append(`<a class="button button-style" data-tab="technosphere-machine"><i class="icon ra ra-sapphire"></i>Technosphere</a>`); // Gather Memnosphere items
